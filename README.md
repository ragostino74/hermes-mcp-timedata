...
- **get_current_datetime_tz** — Data e ora per un fuso orario IANY specificato
...
| `HERMES_MCP_PORT` | `18762` | Porta per la modalità HTTP/StreamableHTTP |
...
3. Aggiungi un nuovo server con:
   - **URL**: `http://localhost:18762/mcp` (o l'IP della tua macchina)
...
Restituisce data/ora corrente per un fuso orario IANY.
